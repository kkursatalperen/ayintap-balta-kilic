...
export async function sendWelcomeEmail({ to, name }) {
  ...
  const base = process.env.NEXT_PUBLIC_BASE_URL || '';
  const body = `
    <p style="margin:0 0 12px 0;">Merhaba <strong style="color:${BRAND.gold};">${escapeHtml(name || 'Degerli Uyemiz')}</strong>,</p>
    <p style="margin:0 0 16px 0;">Ayıntap Kılıç ailesine hoşgeldiniz! Geleneksel ürk çelik sanatını yasatan koleksiyonumuzu keşfetmek için aşağıda ki butona tıklayın.</p>
