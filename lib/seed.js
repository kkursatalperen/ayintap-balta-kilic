...
export async function ensureSeed() {
  ...
  await settings.insertOne({
    ...
    footerAbout: 'Ayıntap Balta Kılıç; Anadolu’nun çelik geleneğini örsten günümüze taşıyan, her bir eseri ustalıkla dövülmüş el yapımı koleksiyonluk kılıç ve balta atölyesidir.',
    createdAt: new Date(),
    updatedAt: new Date()
  });
  ...
  const sectionDocs = [
    ...
    { type: 'story', order: 4, isActive: true, data: { title: 'Hikayemiz', subtitle: 'Üç Kuşaklık Demirci Geleneği', content: 'Gaziantep’in eski adıyla Ayıntap topraklarında, dededen toruna aktarılan bir gelenek… Örsümüzün üzerinde dövülen her çelik, atalarımızın kor ateşinden bir miras taşır. Biz yalnızca metal işlemiyoruz; tarih dövüyoruz.', image: 'https://images.unsplash.com/photo-1658762944591-01e617527ffa?crop=entropy&cs=srgb&fm=jpg&q=85', cta: 'Devamını Oku', link: '/hakkimizda' } },
